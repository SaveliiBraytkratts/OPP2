...
public class Market implements MarketBehavior, QueueBehavior {
    ...
    public void acceptToMarket(Buyer actor) {
        System.out.println(actor.getName() + " Пришол в магазин");
        actors.add(actor);
    }
    ...
    public void releaseFromMarket(Buyer actor) {
        actors.remove(actor);
        System.out.println(actor.getName() + " Ушол из магазина");
    }
    ...
    public void takeOrder() {
        ...
        System.out.println(actorsQueue.peek().getName() + " забрал покупку");
    }

    @Override
    public void giveOrder() {
        actorsQueue.peek().isMakeOrder();
        System.out.println(actorsQueue.peek().getName() + " сделал покупку");
    }
